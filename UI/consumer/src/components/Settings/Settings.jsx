          ...
          <form className="border-black">
            ...
            <div className="flex py-3 px-7 items-center ">
              ...
              <input
                ...
                placeholder={localStorage.getItem("consumerName")}
              />
            </div>
            <div className="flex py-3 px-7 items-center">
              ...
              <input
                type="email"
                className="flex-1 flex justify-end p-3 rounded-md bg-inherit border-black border-[1px]"
                placeholder={localStorage.getItem("consumerEmail")}
              />
            </div>
            <div className="flex py-3 px-7 items-center">
              ...
              <input
                ...
                className="flex-1 flex justify-end p-3 rounded-md bg-inherit border-black border-[1px]"
                required
                placeholder={localStorage.getItem("consumerMobile")}
              />
            </div>
            ...
            {/* <img src={localStorage.getItem("consumerPhoto")}/> */}
          </form>
        </div>
      </div>
    </div>
